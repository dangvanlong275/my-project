...
<ol class="breadcrumb bc-3">
  ...
  <li><a>Manage Major</a></li>
  <li class="active"><strong>List Major</strong></li>
</ol>
<h2>List Major</h2>
<br />
        ...
        <tbody>
            ...
            <tr>
                <form action="./update_major" method="post" >
                    ...
                    <td>
                        <button class="btn btn-danger" onclick = "delete1(<?= $major->manghanh ?>)">Delete</button>
                        <button class="btn btn-info" <?php echo 'onclick=\'window.open("detail_major?id='.$major->manghanh.'","_self")\'' ?>>
                            Detail Major
                        </button>
                    </td>
            </tr>
